...
export default Vue.extend({
  ...
  watch: {
    isListViewVisible(newValue, oldVal) {
      ...
      newValue
        ? ((searchbar.borderBottomLeftRadius = 0), (searchbar.borderBottomRightRadius = 0))
        : ((searchbar.borderBottomLeftRadius = this.borderRadius),
          (searchbar.borderBottomRightRadius = this.borderRadius))
    },
  },
